...
class Extractor():
    ...
    def getRawPage(self):
        ...
        charset = re.compile(r'content="text/html;.?charset=(.*?)"').findall(str(resp.content))

        # print(charset, resp.encoding.lower(), resp.headers['content-type'])
        print(charset)
...
if __name__ == '__main__':
    ext = Extractor(url="http://business.sohu.com/20140629/n401582189.shtml",blockSize=6, image=False)
