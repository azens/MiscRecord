...
void DDALine(int x0, int y0, int xEnd, int yEnd)
{
	...
	x = x0 + 0.5;
	y = y0 + 0.5;//保证计算精度
	step = abs(xEnd - x0) > abs(yEnd - y0) ?
	       abs(xEnd - x0) : abs(yEnd - y0);
...
{
	if (x == 'a') MidCircle(0, 0, 100), Arc(200, 0, 100, 100, -120, -180);
	if (x == 'b')  MidCircle(0, 0, 100), MidLine(-100, 0, -100, 200);
	if (x == 'c') Arc(0, 0, 100, 100, 45, 315);
	if (x == 'd') MidCircle(0, 0, 100), MidLine(100, 0, 100, 200), Arc(200, 0, 100, 100, -120, -180);
	if (x == 'e') MidLine(-100, 0, 100, 0), Arc(0, 0, 100, 100, 0, 315);
	if (x == 'f') MidLine(-50, 0, 50, 0), MidLine(0, -100, 0, 100),
		   Arc(50, 100, 50, 50, 90, 180), Arc(-50, -100, 50, 50, 0, -90);
	if (x == 'g')MidCircle(0, 100, 100), Arc(0, -50, 100, 100, 0, -180), MidLine(100, -50, 100, 100);
	if (x == 'h')MidLine(-50, -100, -50, 100), Arc(0, 0, 50, 50, 0, 180), DDALine(50, 0, 50, -100);
	if (x == 'i')MidLine(10, -100, -10, 100), MidLine(-50, 80, -10, 100), MidLine(10, -100, 50, -80), FillCircle(-10, 150, 25);
	if (x == 'j')MidLine(50, -100, 50, 100), MidLine(0, 80, 50, 100), Arc(0, -100, 50, 50, 0, -180), FillCircle(35, 150, 25);
	if (x == 'k')MidLine(-50, -100, -50, 100), MidLine(-50, 0, 50, 50), MidLine(-50, 0, 50, -100);
	if (x == 'l')DDALine(0, 100, 0, -100), Arc(50, -100, 50, 50, -60, -180);
	if (x == 'm')MidLine(-100, -100, -100, 50), MidLine(0, -100, 0, 50), MidLine(100, -100, 100, 50),
		   Arc(-50, 50, 50, 50, 0, 180), Arc(50, 50, 50, 50, 0, 180), Arc(-150, 50, 50, 50, 0, 80);
	if (x == 'n')MidLine(-100, -100, -100, 50), MidLine(100, -100, 100, 50),
		   Arc(0, 50, 100, 100, 0, 180), Arc(-200, 50, 100, 100, 0, 60);
	if (x == 'o') MidCircle(0, 0, 100);
	if (x == 'p') MidCircle(0, 100, 100), DDALine(-100, 100, -100, -100), Arc(-150, 100, 50, 50, 0, 90);
	if (x == 'q') MidCircle(0, 100, 100), DDALine(100, 100, 100, -100), Arc(150, -100, 50, 50, -90, -180);
	if (x == 'r') DDALine(-50, 40, -50, -100), Arc(0, 0, 50, 50, 30, 180);
	if (x == 's') Arc(0, 50, 50, 50, 30, 270), Arc(0, -50, 50, 50, 210, 450);
	if (x == 't')MidLine(-70, 0, 80, 0), DDALine(0, 50, 0, -100), Arc(50, -100, 50, 50, -60, -180);
	if (x == 'u')DDALine(-50, 50, -50, -50), DDALine(50, 50, 50, -50),
		   Arc(0, -50, 50, 50, 0, -180), Arc(100, -50, 50, 50, -120, -180);
	if (x == 'v')MidLine(-50, 50, 0, -100), MidLine(0, -100, 50, 50);
	if (x == 'w')MidLine(-100, 100, -50, -100), MidLine(-50, -100, 0, 50),
		   MidLine(0, 50, 50, -100), MidLine(50, -100, 100, 100);
	if (x == 'x')MidLine(-50, 50, 50, -50), MidLine(-50, -50, 50, 50);
	if (x == 'y')MidLine(-30, 50, 0, 0), MidLine(-30, -50, 30, 50);
	if (x == 'z')MidLine(-50, 50, 50, 50), MidLine(50, 50, -50, -50), MidLine(-50, -50, 50, -50);
}
